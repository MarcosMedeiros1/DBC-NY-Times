...
import BtnLupa from "./BtnLupa/BtnLupa"
import BtnSanduiche from "./BtnSanduiche/BtnSanduiche"
import BntSubscribe from "./BtnSubscribe/BntSubscribe"
...
function BotoesHeader({ titulo }) {
  return (
      ...
      <div className="container">
        <div className={`${style.header} ${style.borderBottom}`}>
          <div>
